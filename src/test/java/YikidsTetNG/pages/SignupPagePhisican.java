 ...
 */
public class SignupPagePhisican extends Page {
    ...
    public SignupPagePhisican(WebDriver driver) {
        super(driver);
        this.PAGE_URL = "http://physician.yikids.com/signup";
    ...
    //Fill the fields
    public SignupPagePhisican fillFirstnameField(String username) {
        Log.info("Filling username field");
        setElementText(firstNameField, username);
        return this;
    }

    public SignupPagePhisican fillLastNameField(String lastname) {
        Log.info("Filling username field");
        setElementText(lastNameField, lastname);
        return this;
    }

    public SignupPagePhisican fillemailField(String email) {
        Log.info("Filling username field");
        setElementText(emailField, email);
        return this;
    }

    public SignupPagePhisican fillzipcodeField(String zipcode) {
        Log.info("Filling username field");
        setElementText(zipCode1Field, zipcode);
        return this;
    }

    public SignupPagePhisican fillzipCode2Field(String zipcode2) {
        Log.info("Filling username field");
    ...
    //clicking buttons
    public SignupPagePhisican ClickContinueButton() {
